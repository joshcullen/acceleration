...
ggplot(dat2, aes(x = ndwi, color = z.post.thresh)) +
  geom_density(alpha = 0.25, size = 1) +
  scale_color_manual("", values = c(viridis(n=4, option = 'inferno'), "grey")) +
  labs(x = "Mean NDWI (w/in 30 m buffer)", y = "Density") +
  theme(axis.title = element_text(size = 16),
        axis.text = element_text(size = 12),
        strip.text = element_text(size = 12, face = "bold"),
        legend.text = element_text(size = 10))
...
ggplot(dat2, aes(x = bright, color = z.post.thresh)) +
  geom_density(alpha = 0.25, size = 1) +
  scale_color_manual("", values = c(viridis(n=4, option = 'inferno'), "grey")) +
  labs(x = "Mean Brightness (w/in 30 m buffer)", y = "Density") +
  theme(axis.title = element_text(size = 16),
        axis.text = element_text(size = 12),
        strip.text = element_text(size = 12, face = "bold"),
        legend.text = element_text(size = 10))
...
```{r log_regress_calc}
## Compare Slow-Turn vs Slow-Unif (blanca is reference class)
dat.st.su<- dat3 %>% 
...
```{r log_regress_plot, fig.width=12, fig.height=8, fig.cap='Odds ratios for each of the pairwise comparisons between behavioral states.'}
